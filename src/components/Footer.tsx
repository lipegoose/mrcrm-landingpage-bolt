        ...
        <div className="border-t border-gray-900 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Mr.CRM. Desenvolvido pela <a href="https://mrgoose.com.br/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center"><img src="/mrgoose.jpg" alt="Mr.Goose" title="Mr.Goose" className="h-6 w-auto" /> </a> com tecnologia e alma.
            </p>
